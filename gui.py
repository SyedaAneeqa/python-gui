...
def get_result():
    ...
    if operator == "+":
        result_label.configure(text=str(first_number + second_number))
    elif operator == "-":
        result_label.configure(text=str(first_number - second_number))
    elif operator == "*":
        result_label.configure(text=str(first_number * second_number))
        ...
        if second_number == 0:
            ...
            result_label.configure(text=str(round(first_number / second_number,2)))
root = Tk()
...
btn_equals.configure(font=("verdana",14))
